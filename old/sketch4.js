...
//cities.json file taken from this data https://github.com/deremer/Cities
...
//   //testing arlington mass since i know this returns an empty object
//   var arlington_url = "http://maps.google.com/cbk?output=json&hl=en&ll=42.4153925,-71.1564729&radius=50&cb_client=maps_sv&v=4"
//   var json_arlington = loadJSON(arlington_url, gotData, 'jsonp'); //load the json file and log the object to the console
}
...
function loadCities() {
  loadJSON('cities.json', function(cities){
    for (var i = 0; i < cities.length; i ++) {
      //createImage('images/' + cities[i].city)
